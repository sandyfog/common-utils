...
public class ClassUtilTest extends CachedLogger {
	...
	public void getClassNameAsResource() {
		...
		assertEquals("java/lang/String.class",
				ClassUtil.getClassNameAsResource("java.lang.String"));

		assertEquals("xxx/yyy/zzz.class",
				ClassUtil.getClassNameAsResource("xxx.yyy.zzz"));
	}
	...
	public void isInstance() {
		...
		assertFalse(ClassUtil.isInstance(Serializable.class,
				new ClassUtilTest()));
	...
	public void getArrayClass() {
		...
		assertEquals(Integer[][].class,
				ClassUtil.getArrayClass(Integer[].class));
		...
		assertEquals(ClassUtilTest[].class,
				ClassUtil.getArrayClass(ClassUtilTest[].class, 0));
		assertEquals(ClassUtilTest[][].class,
				ClassUtil.getArrayClass(ClassUtilTest[].class, 1));
		assertEquals(ClassUtilTest[][][].class,
				ClassUtil.getArrayClass(ClassUtilTest[].class, 2));
	}
	...
	public void getArrayComponentType() {
		...
		assertEquals(ClassUtilTest.class,
				ClassUtil.getArrayComponentType(ClassUtilTest[].class));
		assertEquals(ClassUtilTest.class,
				ClassUtil.getArrayComponentType(ClassUtilTest[][].class));
		assertEquals(ClassUtilTest.class,
				ClassUtil.getArrayComponentType(ClassUtilTest[][][].class));
		...
		assertEquals(int.class,
				ClassUtil.getArrayComponentType(int[][][].class));

		assertEquals(Integer.class,
				ClassUtil.getArrayComponentType(Integer[].class));
		assertEquals(Integer.class,
				ClassUtil.getArrayComponentType(Integer[][].class));
		assertEquals(Integer.class,
				ClassUtil.getArrayComponentType(Integer[][][].class));
	...
	public void getWrapperTypeIfPrimitive() {
		assertEquals(Integer.class,
				ClassUtil.getWrapperTypeIfPrimitive(int.class));
		assertEquals(Long.class,
				ClassUtil.getWrapperTypeIfPrimitive(long.class));
		assertEquals(Short.class,
				ClassUtil.getWrapperTypeIfPrimitive(short.class));
		assertEquals(Double.class,
				ClassUtil.getWrapperTypeIfPrimitive(double.class));
		assertEquals(Float.class,
				ClassUtil.getWrapperTypeIfPrimitive(float.class));
		assertEquals(Character.class,
				ClassUtil.getWrapperTypeIfPrimitive(char.class));
		assertEquals(Byte.class,
				ClassUtil.getWrapperTypeIfPrimitive(byte.class));
		assertEquals(Boolean.class,
				ClassUtil.getWrapperTypeIfPrimitive(boolean.class));
		assertEquals(Void.class,
				ClassUtil.getWrapperTypeIfPrimitive(void.class));
		...
		assertEquals(String.class,
				ClassUtil.getWrapperTypeIfPrimitive(String.class));
	...
	public void getPrimitiveDefaultValue() {
		assertEquals(new Integer(0),
				ClassUtil.getPrimitiveDefaultValue(int.class));
		assertEquals(new Long(0),
				ClassUtil.getPrimitiveDefaultValue(long.class));
		assertEquals(new Short((short) 0),
				ClassUtil.getPrimitiveDefaultValue(short.class));
		assertEquals(new Double(0),
				ClassUtil.getPrimitiveDefaultValue(double.class));
		assertEquals(new Float(0),
				ClassUtil.getPrimitiveDefaultValue(float.class));
		assertEquals(new Character('\0'),
				ClassUtil.getPrimitiveDefaultValue(char.class));
		assertEquals(new Byte((byte) 0),
				ClassUtil.getPrimitiveDefaultValue(byte.class));
		assertEquals(Boolean.FALSE,
				ClassUtil.getPrimitiveDefaultValue(boolean.class));
		assertEquals(null, ClassUtil.getPrimitiveDefaultValue(void.class));

		assertEquals(new Integer(0),
				ClassUtil.getPrimitiveDefaultValue(Integer.class));
		assertEquals(new Long(0),
				ClassUtil.getPrimitiveDefaultValue(Long.class));
		assertEquals(new Short((short) 0),
				ClassUtil.getPrimitiveDefaultValue(Short.class));
		...
		assertEquals(new Float(0),
				ClassUtil.getPrimitiveDefaultValue(Float.class));
		assertEquals(new Character('\0'),
				ClassUtil.getPrimitiveDefaultValue(Character.class));
		assertEquals(new Byte((byte) 0),
				ClassUtil.getPrimitiveDefaultValue(Byte.class));
		assertEquals(Boolean.FALSE,
				ClassUtil.getPrimitiveDefaultValue(Boolean.class));
		...
		assertEquals(null,
				(Object) ClassUtil.getPrimitiveDefaultValue(long[][].class));
	}
	...
	public void getAllSuperclasses() {
		...
		assertTrue(ClassUtil.getAllSuperclasses(int[].class).isEmpty());
		assertTrue(ClassUtil.getAllSuperclasses(Integer.class).contains(
				Number.class));
	...
	public void getAllInterfaces() {
		...
		// assertTrue(ClassUtil.getAllInterfaces(int[].class).isEmpty());
		assertFalse(ClassUtil.getAllInterfaces(Integer.class).contains(
				Number.class));
		assertTrue(ClassUtil.getAllInterfaces(Integer.class).contains(
				Comparable.class));
