...
import com.baidu.unbiz.common.bean.sample.Ac;
import com.baidu.unbiz.common.bean.sample.Bbean;
import com.baidu.unbiz.common.bean.sample.Bc;
import com.baidu.unbiz.common.bean.sample.Cbean;
import com.baidu.unbiz.common.bean.sample.Overload;
...
public class IntrospectorTest {
	...
	public void testCtors() {
		...
		Constructor<?> ctor = cd.getConstructorDescriptor(
				new Class[] { Integer.class }, true).getConstructor();
		assertNotNull(ctor);
		...
		ConstructorDescriptor ctorDescriptor = cd.getConstructorDescriptor(
				new Class[] { Integer.class }, true);
		assertNull(ctorDescriptor);
		ctor = cd.getConstructorDescriptor(new Class[] { String.class }, true)
				.getConstructor();
		assertNotNull(ctor);
	}
	...
	MethodDescriptor getPropertySetterDescriptor(ClassDescriptor cd,
			String name, boolean declared) {
		PropertyDescriptor propertyDescriptor = cd.getPropertyDescriptor(name,
				true);

		if (propertyDescriptor != null) {
			MethodDescriptor setter = propertyDescriptor
	...
	MethodDescriptor getPropertyGetterDescriptor(ClassDescriptor cd,
			String name, boolean declared) {
		PropertyDescriptor propertyDescriptor = cd.getPropertyDescriptor(name,
				true);

		if (propertyDescriptor != null) {
			MethodDescriptor getter = propertyDescriptor
