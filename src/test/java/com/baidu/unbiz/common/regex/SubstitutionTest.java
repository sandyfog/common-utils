...
public class SubstitutionTest {
	...
	public void matchOverflowNumber() {
		...
		// a negative number
		assertEquals("xx$12345678901234567890yy$2zz",
				subs.substitute("xx$12345678901234567890yy$2zz"));
	}
	...
	public void matchMulti() {
		...
		assertEquals(
				"\\saga67, $1, $x, .saga67.com/test.htm, saga67, test.htm, $3, %1, %x, a=1&b=2, 1, 2, %3, \\",
