...
public class JVMUtilTest extends CachedLogger {
	...
	public void appendToClassPath() {
		...
		assertTrue(JVMUtil.appendToClassPath(classpath + File.separator
				+ "lib/test1.jar"));
		...
		assertFalse(JVMUtil.appendToClassPath(classpath + File.separator
				+ "lib/notexist.jar"));
	...
	public void getManifest() {
		...
		assertNull(JVMUtil
				.getManifest(new File(ClassLoaderUtil.getClasspath())));
		try {
			assertNull(JVMUtil.getManifest(new File(ClassLoaderUtil
					.getClasspath(), "log4j.properties")));
		} catch (Exception e) {
			...
			assertEquals(java.util.zip.ZipException.class, e.getCause()
					.getClass());
		}

		Manifest manifest = JVMUtil.getManifest(new File(System
	...
	public void getClasspath() {
		...
		assertArrayEquals(JVMUtil.getClasspath(),
				JVMUtil.getClasspath(ClassLoader.getSystemClassLoader()));
