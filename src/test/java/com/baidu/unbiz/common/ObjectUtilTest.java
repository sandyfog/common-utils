...
public class ObjectUtilTest {
	...
	public void testNull() {
		...
		assertTrue(ObjectUtil.isAllNull(new Object[] { null, null, null, null,
				null }));
		assertFalse(ObjectUtil
				.isEmpty(new Object[] { null, null, 0, null, null }));

		// any null
		assertTrue(ObjectUtil.isAnyNull(NULL));
		assertTrue(ObjectUtil.isAnyNull(new Object[] { null, null, null, null,
				null }));
		assertTrue(ObjectUtil.isAnyNull(new Object[] { null, null, 0, null,
				null }));
		assertTrue(ObjectUtil.isAnyNull(new Object[] { null, "null", 0, null,
				null }));
		assertFalse(ObjectUtil.isAnyNull(new Object[] { "", "null", 0,
				new int[] {}, CollectionUtil.createArrayList() }));
	}
