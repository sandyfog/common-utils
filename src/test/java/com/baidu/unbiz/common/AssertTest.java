...
public class AssertTest {
	...
	public void assertNotNull() {
		...
		try {
			...
			assertThat(
					e,
					exception(IllegalArgumentException.class, DEFAULT_HEADER,
							"must not be null"));
		}
		...
		// form 3
		Assert.assertNotNull(OBJECT, Assert.ExceptionType.ILLEGAL_STATE,
				MESSAGE);

		try {
			Assert.assertNotNull(null, Assert.ExceptionType.ILLEGAL_STATE,
					MESSAGE);
	...
	public void assertNull() {
		...
		try {
			Assert.assertNull(OBJECT, Assert.ExceptionType.ILLEGAL_STATE,
					MESSAGE);
		} catch (IllegalStateException e) {
			assertThat(e, exception(IllegalStateException.class, MESSAGE));
		}
	...
	public void assertTrue() {
		...
		try {
			Assert.assertTrue(false, Assert.ExceptionType.ILLEGAL_STATE,
					MESSAGE);
		} catch (IllegalStateException e) {
			assertThat(e, exception(IllegalStateException.class, MESSAGE));
		}
	...
	public void unreachableCode() {
		try {
			...
			assertThat(
					e,
					exception(UnreachableCodeException.class, DEFAULT_HEADER,
							"unreachable"));
		}
	...
	public void unexpectedException() {
		...
		try {
			...
			assertThat(
					ee,
					exception(UnexpectedFailureException.class, DEFAULT_HEADER,
							"unexpected"));
		}
		...
		try {
			...
			assertThat(ee,
					exception(UnexpectedFailureException.class, MESSAGE_1));
		}
	...
	public void unsupportedOperation() {
		...
		try {
			...
			assertThat(e,
					exception(UnsupportedOperationException.class, MESSAGE));
		}
		...
		try {
			...
			assertThat(e,
					exception(UnsupportedOperationException.class, MESSAGE_1));
		}
	}
}
