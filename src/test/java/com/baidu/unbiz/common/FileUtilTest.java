...
public class FileUtilTest extends CachedLogger {
	...
	public void listDirSuffixFiles() {
		...
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
				+ "notexist", null));
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
				+ "xxx/yyy/zzz", null));
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
		...
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
				+ "notexist", ".properties"));
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
				+ "xxx/yyy/zzz", ".properties"));
		assertNull(FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath()
				+ "log4j.properties", ".properties"));

		assertArrayEquals(new File[] {}, FileUtil.listDirSuffixFiles(
				ClassLoaderUtil.getClasspath(), ".nothissuffix"));

		int expected = new File(ClassLoaderUtil.getClasspath())
				.listFiles(new FileFilter() {
					public boolean accept(File file) {
						return (file.getName().endsWith(".properties"));
					}
				}).length;
		assertEquals(expected, FileUtil.listDirSuffixFiles(
				ClassLoaderUtil.getClasspath(), ".properties").length);

		expected = new File(ClassLoaderUtil.getClasspath()).listFiles().length;
		assertEquals(expected, FileUtil.listDirSuffixFiles(
				ClassLoaderUtil.getClasspath(), null).length);
		assertEquals(
				expected,
				FileUtil.listDirSuffixFiles(ClassLoaderUtil.getClasspath(), "").length);
	}
	...
	public void listDirAllConditionFiles() {
		...
		assertNull(FileUtil.listDirAllConditionFiles(
				ClassLoaderUtil.getClasspath() + "notexist", null));
		assertNull(FileUtil.listDirAllConditionFiles(
				ClassLoaderUtil.getClasspath() + "xxx/yyy/zzz", null));
		assertNull(FileUtil.listDirAllConditionFiles(
				ClassLoaderUtil.getClasspath() + "log4j.properties", null));

		int expected = new File(ClassLoaderUtil.getClasspath()).listFiles().length;
		assertEquals(
				expected,
				FileUtil.listDirAllConditionFiles(
						ClassLoaderUtil.getClasspath(), null).length);
		assertEquals(
				expected,
				FileUtil.listDirAllConditionFiles(
						ClassLoaderUtil.getClasspath(), new boolean[] {}).length);

		assertArrayEquals(
				new File[] {},
				FileUtil.listDirAllConditionFiles(
						ClassLoaderUtil.getClasspath(), new boolean[] { true,
								true, false, true, true }));

		assertArrayEquals(new File[] {}, FileUtil.listDirAllConditionFiles(
				ClassLoaderUtil.getClasspath(), true, true, false, true, true));
		...
		assertEquals(expected,
				FileUtil.listDirAllConditionFiles(
						ClassLoaderUtil.getClasspath(), true, true, true, true,
						true).length);
	}
	...
	public void listDirAnyConditionFiles() {
		...
		assertNull(FileUtil.listDirAnyConditionFiles(
				ClassLoaderUtil.getClasspath() + "notexist", null));
		assertNull(FileUtil.listDirAnyConditionFiles(
				ClassLoaderUtil.getClasspath() + "xxx/yyy/zzz", null));
		assertNull(FileUtil.listDirAnyConditionFiles(
		...
		assertEquals(
				expected,
				FileUtil.listDirAnyConditionFiles(
						ClassLoaderUtil.getClasspath(), null).length);
		assertEquals(
				expected,
				FileUtil.listDirAnyConditionFiles(
		...
		assertArrayEquals(
				new File[] {},
				FileUtil.listDirAnyConditionFiles(
						ClassLoaderUtil.getClasspath(), new boolean[] { false,
								false, false, false, false }));

		assertArrayEquals(new File[] {}, FileUtil.listDirAnyConditionFiles(
				ClassLoaderUtil.getClasspath(), false, false, false, false,
				false));
		...
		assertEquals(
				...
				FileUtil.listDirAnyConditionFiles(
						ClassLoaderUtil.getClasspath(), new boolean[] { false,
								true, false, false, false }).length);
		assertEquals(expected, FileUtil.listDirAnyConditionFiles(
				ClassLoaderUtil.getClasspath(), false, true, false, false,
				false).length);
	}
	...
	public void file() {
		...
		assertNull(FileUtil
				.file(new File(ClassLoaderUtil.getClasspath()), null));
	...
	public void readBytes() {
		try {
			...
			String log4jPath = ClassLoaderUtil.getClasspath()
