...
import com.baidu.unbiz.common.exception.ServiceNotFoundException;
import com.baidu.unbiz.common.logger.CachedLogger;
import com.baidu.unbiz.common.sample.MyService;

/**
 * @author <a href="mailto:xuchen06@baidu.com">xuc</a>
 * @version create on 2014年7月16日 下午1:42:45
 */
public class ClassLoaderUtilTest extends CachedLogger {
	...
	public void loadClass() throws Exception {
		...
		assertSame(String.class,
				ClassLoaderUtil.loadClass("java.lang.String", getClass()));
		assertSame(String.class,
				ClassLoaderUtil.loadClass("java.lang.String", (Class<?>) null));
	...
	public void loadServiceClass() throws Exception {
		...
		assertEquals(MyService.class,
				ClassLoaderUtil.loadServiceClass("myservice"));
		...
		assertEquals(MyService.class,
				ClassLoaderUtil.loadServiceClass("myservice", getClass()));
		assertEquals(MyService.class,
				ClassLoaderUtil.loadServiceClass("myservice", (Class<?>) null));
		...
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", getClass().getClassLoader()));
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", (ClassLoader) null));

		try {
			assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
					"com.baidu.unbiz.common.sample.MyService", getClass()
							.getClassLoader()));
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
		...
		try {
			assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
					"com.baidu.unbiz.common.sample.MyService",
					(ClassLoader) null));
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
	...
	public void loadServiceClass_ClassNameServiceId() throws Exception {
		...
		assertEquals(MyService.class,
				ClassLoaderUtil.loadServiceClass("myservice", "myservice"));

		// load from class referrer
		assertNull(ClassLoaderUtil.loadServiceClass(null, null, getClass()));
		assertNull(ClassLoaderUtil
				.loadServiceClass(null, null, (Class<?>) null));

		try {
			ClassLoaderUtil.loadServiceClass("myservice.notexist",
					"myservice.notexist", getClass());
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
		...
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", "myservice", getClass()));
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", "myservice", (Class<?>) null));

		// load from specified loader
		assertNull(ClassLoaderUtil.loadServiceClass(null, null, getClass()
				.getClassLoader()));
		assertNull(ClassLoaderUtil.loadServiceClass(null, null,
				(ClassLoader) null));

		try {
			ClassLoaderUtil.loadServiceClass("myservice.notexist",
					"myservice.notexist", getClass().getClassLoader());
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
		...
		try {
			ClassLoaderUtil.loadServiceClass("myservice.notfound",
					"myservice.notfound", getClass().getClassLoader());
			fail("expected ClassNotFoundException");
		} catch (ClassNotFoundException e) {
			assertFalse(e instanceof ServiceNotFoundException);
		}
		...
		try {
			ClassLoaderUtil.loadServiceClass("myservice.notexist",
					"myservice.notexist", (ClassLoader) null);
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
		...
		try {
			ClassLoaderUtil.loadServiceClass("myservice.notfound",
					"myservice.notfound", (ClassLoader) null);
			fail("expected ClassNotFoundException");
		} catch (ClassNotFoundException e) {
			assertFalse(e instanceof ServiceNotFoundException);
		}
		...
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", "myservice", getClass().getClassLoader()));
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"myservice", "myservice", (ClassLoader) null));
		...
		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"com.baidu.unbiz.common.sample.MyService",
				"com.baidu.unbiz.common.sample.MyService", (ClassLoader) null));

		assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass(
				"com.baidu.unbiz.common.sample.MyService", "abc"));
		assertEquals(MyService.class,
				ClassLoaderUtil.loadServiceClass("abc", "myservice"));
	}
	...
	public void newInstance() throws Exception {
		// load from context loader
		assertNull(ClassLoaderUtil.newInstance((String) null));
		assertNull(ClassLoaderUtil.newInstance((Class<?>) null));
		assertInstance(String.class,
				ClassLoaderUtil.newInstance("java.lang.String"));

		try {
			ClassLoaderUtil
					.newInstance("com.baidu.unbiz.common.sample.MyErrorService");
		...
		assertInstance(String.class,
				ClassLoaderUtil.newInstance("java.lang.String", getClass()));
		assertInstance(String.class, ClassLoaderUtil.newInstance(
				"java.lang.String", (Class<?>) null));

		try {
			ClassLoaderUtil.newInstance(
					"com.baidu.unbiz.common.sample.MyErrorService", getClass());
			fail("Expected ClassInstantiationException");
		} catch (ClassInstantiationException e) {
		}
	...
	public void newServiceInstance() throws Exception {
		...
		assertInstance(MyService.class,
				ClassLoaderUtil.newServiceInstance("myservice"));
		...
		try {
			ClassLoaderUtil
					.newServiceInstance("myservice.notexist", getClass());
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
		}
		...
		try {
			ClassLoaderUtil
					.newServiceInstance("myservice.notfound", getClass());
			fail("expected ClassNotFoundException");
		} catch (ClassNotFoundException e) {
			assertFalse(e instanceof ServiceNotFoundException);
		}
		...
		assertInstance(MyService.class,
				ClassLoaderUtil.newServiceInstance("myservice", getClass()));
		assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance(
		...
		try {
			assertEquals(MyService.class, ClassLoaderUtil.newServiceInstance(
					"com.baidu.unbiz.common.sample.MyService", getClass()
							.getClassLoader()));
			fail("expected ServiceNotFoundException");
		} catch (ServiceNotFoundException e) {
	...
	public void newServiceInstance_ClassNameServiceId() throws Exception {
		...
		try {
			ClassLoaderUtil
					.newServiceInstance("myservice.err", "myservice.err");
			fail("Expected ClassInstantiationException");
		} catch (ClassInstantiationException e) {
		}

		assertInstance(MyService.class,
				ClassLoaderUtil.newServiceInstance("myservice", "myservice"));

		// load from class referrer
		assertNull(ClassLoaderUtil.newServiceInstance(null, null, getClass()));
		assertNull(ClassLoaderUtil.newServiceInstance(null, null,
				(Class<?>) null));
		...
		try {
			ClassLoaderUtil.newServiceInstance("myservice.err",
					"myservice.err", getClass().getClassLoader());
			fail("Expected ClassInstantiationException");
		} catch (ClassInstantiationException e) {
		}
		...
		assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance(
				"com.baidu.unbiz.common.sample.MyService", "abc"));
		assertInstance(MyService.class,
				ClassLoaderUtil.newServiceInstance("abc", "myservice"));
	}
	...
	public void getResources() throws Exception {
		...
		assertEquals(0,
				ClassLoaderUtil.getResources(null, (Class<?>) null).length);
		urls = ClassLoaderUtil.getResources("META-INF/MANIFEST.MF", getClass());
		assertUnique(urls);
		urls = ClassLoaderUtil.getResources("META-INF/MANIFEST.MF",
				(Class<?>) null);
		assertUnique(urls);
		...
		assertEquals(
				0,
				ClassLoaderUtil.getResources(null, getClass().getClassLoader()).length);
		assertEquals(0,
				ClassLoaderUtil.getResources(null, (ClassLoader) null).length);
		urls = ClassLoaderUtil.getResources("META-INF/MANIFEST.MF", getClass()
				.getClassLoader());
		assertUnique(urls);
		urls = ClassLoaderUtil.getResources("META-INF/MANIFEST.MF",
	...
	public void getResourceAsStream() throws Exception {
		...
		assertNotNull(ClassLoaderUtil.getResourceAsStream(
				"META-INF/MANIFEST.MF", getClass()));
		assertNotNull(ClassLoaderUtil.getResourceAsStream(
				"META-INF/MANIFEST.MF", (Class<?>) null));

		// load from specified loader
		assertNull(ClassLoaderUtil.getResourceAsStream(null, getClass()
				.getClassLoader()));
		assertNull(ClassLoaderUtil
				.getResourceAsStream(null, (ClassLoader) null));
		assertNotNull(ClassLoaderUtil.getResourceAsStream(
				"META-INF/MANIFEST.MF", getClass().getClassLoader()));
		assertNotNull(ClassLoaderUtil.getResourceAsStream(
				"META-INF/MANIFEST.MF", (ClassLoader) null));
	}

	private void assertUnique(URL[] urls) {
		assertTrue(urls != null && urls.length > 0);

		Set<URL> set = CollectionUtil.createHashSet(urls);
	...
	public void whichClasses() throws Exception {
		...
		assertEquals(0,
				ClassLoaderUtil.whichClasses("aaa.NotExistClass").length);
		...
		assertEquals(0,
				ClassLoaderUtil.whichClasses(null, (Class<?>) null).length);
		assertEquals(
				0,
				ClassLoaderUtil.whichClasses("aaa.NotExistClass", getClass()).length);
		assertEquals(0, ClassLoaderUtil.whichClasses("aaa.NotExistClass",
				(Class<?>) null).length);

		urls = ClassLoaderUtil.whichClasses("java.lang.String", getClass());
		assertUnique(urls);
		urls = ClassLoaderUtil
				.whichClasses("java.lang.String", (Class<?>) null);
		assertUnique(urls);

		// load from specified loader
		assertEquals(
				0,
				ClassLoaderUtil.whichClasses(null, getClass().getClassLoader()).length);
		assertEquals(0,
				ClassLoaderUtil.whichClasses(null, (ClassLoader) null).length);
		assertEquals(0, ClassLoaderUtil.whichClasses("aaa.NotExistClass",
				getClass().getClassLoader()).length);
		assertEquals(0, ClassLoaderUtil.whichClasses("aaa.NotExistClass",
				(ClassLoader) null).length);

		urls = ClassLoaderUtil.whichClasses("java.lang.String", getClass()
				.getClassLoader());
		assertUnique(urls);
		urls = ClassLoaderUtil.whichClasses("java.lang.String",
				(ClassLoader) null);
		assertUnique(urls);
	}
	...
	public void whichClass() throws Exception {
		...
		assertNotNull(ClassLoaderUtil
				.whichClass("java.lang.String", getClass()));
		assertNotNull(ClassLoaderUtil.whichClass("java.lang.String",
				(Class<?>) null));

		// load from specified loader
		assertNull(ClassLoaderUtil
				.whichClass(null, getClass().getClassLoader()));
