...
import com.baidu.unbiz.common.convert.AssertArraysTestHelper;
...
public class ArraysTest {
	...
	public void testIntToArrayConversion() {
		int[] primitives = INTS;
		Object result = ConverterManager.convertType(primitives,
				Integer[].class);
	...
	public void testDoubleToArrayConversion() {
		...
		Object result = ConverterManager
				.convertType(primitives, Double[].class);
	...
	public void testArrayToIntConversionSingleValue() {
		Object result = ConverterManager.convertType(Integer.valueOf(173),
				int[].class);
	...
	public void testIntToLongArray2() {
		...
		assertNotNull(result);
		AssertArraysTestHelper.assertArrayEquals(new long[][] { { 1, 2, 3 },
				{ 4, 5 } }, (long[][]) result);
	}
	...
	public void testBigIntegerToInteger() {
		Object bigIntegers = new BigInteger[] { new BigInteger("7"),
				new BigInteger("3"), new BigInteger("1") };

		Object result = ConverterManager.convertType(bigIntegers,
				Integer[].class);
		assertNotNull(result);
	...
	public void testIntegerToBigInteger() {
		Object integers = new Integer[] { new Integer(7), new Integer(3),
				new Integer(1) };

		Object result = ConverterManager.convertType(integers,
				BigInteger[].class);
		assertNotNull(result);
