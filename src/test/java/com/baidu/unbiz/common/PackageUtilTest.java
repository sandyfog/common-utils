...
public class PackageUtilTest extends CachedLogger {
	...
	public void getClassesInPackage() throws IOException {
		...
		assertNull(PackageUtil.getClassesInPackage("     ", null, null));
		assertNull(PackageUtil.getClassesInPackage(null,
				Arrays.asList(new String[] { "com.baidu.unbiz.common" }), null));
		assertNull(PackageUtil.getClassesInPackage("",
				Arrays.asList(new String[] { "com.baidu.unbiz.common" }), null));
		assertNull(PackageUtil.getClassesInPackage("     ",
				Arrays.asList(new String[] { "com.baidu.unbiz.common" }), null));

		assertTrue(CollectionUtil.isEmpty(PackageUtil
				.getClassesInPackage("com.baidu.beidou.xxx")));
		assertTrue(CollectionUtil.isEmpty(PackageUtil
				.getClassesInPackage("notexist")));

		List<String> utils = PackageUtil
				.getClassesInPackage("com.baidu.unbiz.common");
		assertTrue(CollectionUtil.isNotEmpty(utils));

		List<String> subUtils = PackageUtil
				.getClassesInPackage("com.baidu.unbiz.common.*");
		...
		assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage(
				"com.baidu.unbiz.common.*",
				Arrays.asList(new String[] { ".*" }),
				Arrays.asList(new String[] { ".*" }))));
		assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage(
				"com.baidu.unbiz.common.*", null,
				Arrays.asList(new String[] { ".*" }))));

		List<String> includeTests = PackageUtil.getClassesInPackage(
				"com.baidu.unbiz.common.*",
				Arrays.asList(new String[] { ".*Test" }), null);
		assertTrue(CollectionUtil.isNotEmpty(includeTests));
		List<String> excludeTests = PackageUtil.getClassesInPackage(
				"com.baidu.unbiz.common.*", null,
		...
		List<String> langs = PackageUtil
				.getClassesInPackage("org.slf4j");
		assertTrue(CollectionUtil.isNotEmpty(langs));
		List<String> subLangs = PackageUtil
				.getClassesInPackage("org.slf4j.*");
	...
	public void getResourceInPackage() throws IOException {
		...
		assertTrue(CollectionUtil.isEmpty(PackageUtil
				.getResourceInPackage("com.baidu.beidou.xxx")));
		assertTrue(CollectionUtil.isEmpty(PackageUtil
				.getResourceInPackage("notexist")));
		List<String> utils = PackageUtil
				.getResourceInPackage("com.baidu.unbiz.common");
		assertTrue(CollectionUtil.isNotEmpty(utils));
		List<String> subUtils = PackageUtil
				.getResourceInPackage("com.baidu.unbiz.common.*");
		assertTrue(CollectionUtil.isNotEmpty(subUtils));
		...
		List<String> langs = PackageUtil
				.getResourceInPackage("org.slf4j");
		assertTrue(CollectionUtil.isNotEmpty(langs));
		List<String> subLangs = PackageUtil
				.getResourceInPackage("org.slf4j.*");
		assertTrue(CollectionUtil.isNotEmpty(subLangs));
	...
	public void getPackage() {
		...
		assertEquals("java.lang", PackageUtil.getPackage(String.class)
				.getName());

		assertEquals("com.baidu.unbiz.common",
				PackageUtil.getPackage(PackageUtil.class).getName());
