...
import com.baidu.unbiz.common.collection.ArrayHashMapTest.Constructors;
import com.baidu.unbiz.common.collection.ArrayHashMapTest.ListMapBasic;
import com.baidu.unbiz.common.collection.ArrayHashMapTest.ListMapEntryList;
import com.baidu.unbiz.common.collection.ArrayHashMapTest.ListMapKeyList;
import com.baidu.unbiz.common.collection.ArrayHashMapTest.ListMapValueList;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ Constructors.class, ListMapBasic.class, ListMapEntryList.class,
		ListMapKeyList.class, ListMapValueList.class })
public class ArrayHashMapTest {
	...
	public static class ListMapBasic extends AbstractListMapTest {
		...
		protected ListMap<Object, Object> cloneListMap(
				ListMap<Object, Object> map) {
			return (ListMap<Object, Object>) ((ArrayHashMap<Object, Object>) map)
					.clone();
		}
	}
	...
	public static class Constructors {
		 ...
		 *            期望的容量
		 */
		private void assertParameters(int expectedThreshold,
