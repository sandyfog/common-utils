 ...
 * @version create on 2014年8月1日 下午1:34:42
 */
public abstract class AbstractListMapTest extends AbstractTest {
	...
	public void removeEntry() {
		...
		for (int i = 0; i < 50; i++) {
			key += "a";
			assertEquals(new DefaultMapEntry<Object, Object>(key,
					new Integer(i)), map1.removeEntry(0));
		...
		for (int i = 99; i >= 50; i--) {
			...
			assertEquals(new DefaultMapEntry<Object, Object>(key,
					new Integer(i)), map1.removeEntry(i - 50));
		...
		// map2
		assertEquals(new DefaultMapEntry<Object, Object>(null, "111"),
				map2.removeEntry(0));
		assertEquals(new DefaultMapEntry<Object, Object>("aaa", null),
				map2.removeEntry(0));
	 ...
	 * @return 复制品
	 */
	protected abstract ListMap<Object, Object> cloneListMap(
