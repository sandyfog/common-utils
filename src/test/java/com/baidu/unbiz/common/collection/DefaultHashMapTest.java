 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ Constructors.class, MapBasic.class, MapEntrySet.class,
		MapKeySet.class, MapValues.class })
public class DefaultHashMapTest {
	...
	public static class MapBasic extends AbstractMapTest {
		...
		protected Map<Object, Object> cloneMap(Map<Object, Object> map) {
			return (Map<Object, Object>) ((DefaultHashMap<Object, Object>) map)
					.clone();
		}

		@Override
		protected int getThreshold(Map<Object, Object> map) {
			return DefaultHashMapTest
					.getThreshold((DefaultHashMap<Object, Object>) map);
		}

		@Override
		protected int getCapacity(Map<Object, Object> map) {
			return DefaultHashMapTest
					.getCapacity((DefaultHashMap<Object, Object>) map);
		}
	}
