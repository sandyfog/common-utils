 ...
 * @version create on 2014年8月1日 下午1:45:21
 */
public abstract class AbstractMapViewTest extends AbstractTest {
	...
	public void iterator() {
		...
		for (Iterator<?> i = view1.iterator(); i.hasNext(); count++) {
			...
			assertTrue(isEqual(newItem("aaa", "111"), entry)
					|| isEqual(newItem("bbb", "222"), entry)
		...
		for (Iterator<?> i = view2.iterator(); i.hasNext(); count++) {
			...
			assertTrue(isEqual(newItem("aaa", null), entry)
					|| isEqual(newItem(null, "111"), entry));
		}
