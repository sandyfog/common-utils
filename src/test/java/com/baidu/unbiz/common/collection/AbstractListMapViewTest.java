 ...
 * @version create on 2014年8月1日 下午1:38:23
 */
public abstract class AbstractListMapViewTest extends AbstractTest {
	...
	public void containsAll() {
		...
		items = CollectionUtil.createArrayList(newItem("aaa", "111"), newItem("bbb", "222"),
				newItem("ccc", "333"));
		assertTrue(view1.containsAll(items));

		items = CollectionUtil.createArrayList(newItem("aaa", null),
				newItem(null, "111"));
		assertTrue(view2.containsAll(items));

		items = CollectionUtil.createArrayList();
		assertTrue(view1.containsAll(items));
		assertTrue(view2.containsAll(items));
