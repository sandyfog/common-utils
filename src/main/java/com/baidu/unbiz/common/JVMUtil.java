...
public abstract class JVMUtil {
	...
	/**
	 * 获取<code>classpath</code>下的<code>Manifest</code>，如果文件不存在，返还
	 * <code>null</code>
	 * 
	 * @param classpathItem
	 *            文件项路径，如果为<code>null</code>，则返还<code>null</code>
	 * @return ## @see Manifest
	 */
	...
	/**
	 * 使用默认的classloader获取classpath下所有资源的路径文件 @see
	 * {@link #getClasspath(ClassLoader)}
	 * 
	...
	public static final class JavaRuntimeInfo {
		 ...
		 * 
		 * @return <code>32</code> or <code>64</code>-bit operation,if not
		 *         support the property, return <code>unknown</code>
		 */
