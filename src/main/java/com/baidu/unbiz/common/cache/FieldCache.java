...
public class FieldCache {
	...
	public Field[] getFields(final Class<?> clazz,
		...
		return cache.get(ClassUtil.getFriendlyClassName(clazz) + "."
				+ annotationClass.getName(), new Callable<Field[]>() {
			@Override
			public Field[] call() throws Exception {
				return ReflectionUtil.getAnnotationFields(clazz,
						annotationClass);
			}
		});
	}
	...
	/**
	 * 生成并缓存<code>clazz</code>中带<code>annotationClass</code>名为
	 * <code>fieldName</code>的 <code>Field</code>
	 * 
	 * @param clazz
	 *            目标class
	 * @param annotationClass
	 ...
	 * @return 所有带<code>annotationClass</code>的 <code>Field</code>
	 */
	public Field getField(final Class<?> clazz,
			final Class<? extends Annotation> annotationClass, String fieldName) {
		if (clazz == null) {
			return null;
		}
