...
import com.baidu.unbiz.common.able.TransformTo;
 ...
 */
public enum PrimitiveArray implements Valuable<Class<?>>, TransformTo<Class<?>> {
	...
	public static PrimitiveArray find(Class<?> clazz) {
