...
public interface FileProcessor {
	...
	void importBeans(Class<?> clazz, Object[] beans, String filePath)
			throws IOException;
	...
	// FIXME
	void importBeans(String[] headers, Class<?> clazz, Object[] beans,
			String filePath) throws IOException;

	void importBeans(ListMap<String, String> headers, Class<?> clazz,
