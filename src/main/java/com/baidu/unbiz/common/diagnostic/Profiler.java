...
public final class Profiler {
	...
	public static final class Entry {
		private final List<Entry> subEntries = CollectionUtil
				.createArrayList(4);
		 ...
		 *            后续行前缀
		 */
		private void toString(StringBuilder builder, String prefix1,
				String prefix2) {
			...
			double selfPercent = duration == 0 ? 0 : (double) durationOfSelf
					/ duration;
