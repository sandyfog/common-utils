...
public abstract class WriterUtil {
	 ...
	 * @throws IOException
	 */
	public static boolean writeLinesAndClose(String filePath,
			Collection<?> datas) throws IOException {
	 ...
	 */
	public static boolean writeLinesAndClose(String filePath,
			Collection<?> datas, String charsetName) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static boolean writeLinesAndClose(String filePath, Object... datas)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static boolean writeLinesAndClose(String filePath, Object data)
			throws IOException {
		return writeLinesAndClose(filePath, data, false);
	}

	public static boolean writeLinesAndClose(File file, Object data)
			throws IOException {
	 ...
	 * @param append
	 *            是否追加
	 * @return 是否成功，如果<code>path</code>为空或者<code>path</code>为<code>null</code>
	 *         ,则返回<code>false</code>
	 * @throws IOException
	 */
	public static boolean writeLinesAndClose(String filePath,
	 ...
	 * @throws IOException
	 */
	public static boolean writeLinesAndClose(String filePath, boolean append,
			Object... datas) throws IOException {
	 ...
	 */
	public static boolean writeLinesAndClose(String filePath, boolean append,
			String charsetName, Object... datas) throws IOException {
	...
	public static void writeLinesAndClose(Collection<?> datas,
			OutputStream out, String charsetName) throws IOException {
		Writer writer = null;
		try {
	...
	public static void writeLinesAndClose(OutputStream out, String charsetName,
			Object... datas) throws IOException {
		Writer writer = null;
		try {
			writer = new OutputStreamWriter(out, charsetName);
	...
	private static Writer getWriter(File file, boolean append,
			String charsetName) throws IOException {
