...
public class ISO8601Formatter extends AbstractFormatter {
	...
	protected String convertPattern(int patternIndex, DatetimeObject jdt) {
		...
		case 17:
			return jdt.getTimeZone().getDisplayName(jdt.isInDaylightTime(),
					TimeZone.LONG, jdt.getLocale());
		case 18:
			return jdt.getTimeZone().getDisplayName(jdt.isInDaylightTime(),
					TimeZone.SHORT, jdt.getLocale());
		default:
	...
	protected void parseValue(int patternIndex, String value,
		...
		case 11:
			...
			break;
		default:
			throw new IllegalArgumentException("Parsing template failed: "
