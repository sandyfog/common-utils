 ...
 */
public class DateTimeStamp implements Comparable<DateTimeStamp>, Serializable,
		CloneableObject<DateTimeStamp> {
	...
	public int compareTo(DateTimeStamp another) {
		...
		int anotherDate = another.year * 10000 + another.month * 100
				+ another.day;
		...
		thisDate = (hour * 10000000) + (minute * 100000) + (second * 1000)
				+ millisecond;
		anotherDate = (another.hour * 10000000) + (another.minute * 100000)
				+ (another.second * 1000) + another.millisecond;
	...
	public boolean equals(Object object) {
		...
		return (stamp.year == this.year) && (stamp.month == this.month)
				&& (stamp.day == this.day) && (stamp.hour == this.hour)
