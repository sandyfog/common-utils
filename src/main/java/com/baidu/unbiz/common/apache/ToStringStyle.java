 ...
 * @version create on 2014年9月15日 上午5:38:57
 */
public abstract class ToStringStyle {

	/**
	 * The default toString style. Using the Using the <code>Person</code>
	 * example from {@link ToStringBuffer}, the output would look like this:
	 * 
	 * <pre>
	 ...
	 * <code>Person</code> example from {@link ToStringBuffer}, the output would
	 * look like this:
	 * 
	 * <pre>
	 ...
	 * from {@link ToStringBuffer}, the output would look like this:
	 * 
	 * <pre>
	...
	protected void appendCyclicObject(StringBuffer buffer, String fieldName,
			Object value) {
		ObjectUtil.appendIdentityToString(buffer, value);
	}
	 ...
	 */
	protected String getShortClassName(Class<? extends Object> cls) {
	...
	private static final class MultiLineToStringStyle extends ToStringStyle {
		...
		MultiLineToStringStyle() {
			super();
			this.setContentStart("[");
			this.setFieldSeparator(SystemUtil.getOsInfo().getLineSeparator()
					+ "  ");
			this.setFieldSeparatorAtStart(true);
			this.setContentEnd(SystemUtil.getOsInfo().getLineSeparator() + "]");
		}
