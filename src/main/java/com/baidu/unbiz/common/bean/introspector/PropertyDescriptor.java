 ...
 * @version create on 2014年9月19日 上午1:06:38
 */
public class PropertyDescriptor extends Descriptor {
	...
	public PropertyDescriptor(ClassDescriptor classDescriptor,
			String propertyName, FieldDescriptor fieldDescriptor) {
	...
	public PropertyDescriptor(ClassDescriptor classDescriptor,
			String propertyName, MethodDescriptor readMethod,
	...
	public boolean isFieldOnlyDescriptor() {
		return (readMethodDescriptor == null)
