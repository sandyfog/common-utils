...
public class CachingIntrospector implements Introspector {
	...
	protected final Map<Class<?>, ClassDescriptor> cache = CollectionUtil
			.createHashMap();
	...
	public CachingIntrospector(boolean scanAccessible,
			boolean enhancedProperties, boolean includeFieldsAsProperties,
	...
	protected ClassDescriptor describeClass(Class<?> type) {
		return new ClassDescriptor(type, scanAccessible, enhancedProperties,
				includeFieldsAsProperties, propertyFieldPrefix);
	}
