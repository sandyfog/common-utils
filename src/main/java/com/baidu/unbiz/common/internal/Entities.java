...
import com.baidu.unbiz.common.collection.IntHashMap;
 ...
 * @version create on 2014年9月15日 上午5:19:29
 */
public class Entities {
	/** 基本实体定义。 */
	private static final String[][] BASIC_SET = { { "quot", "34" }, // " -
																	// double-quote
			{ "amp", "38" }, // & - ampersand
			{ "lt", "60" }, // < - less-than
			{ "gt", "62" }, // > - greater-than
	...
	/** XML省略语。 */
	private static final String[][] APOS_SET = { { "apos", "39" }, // XML
																	// apostrophe
	};

	/** 8859-1实体定义。 */
	private static final String[][] ISO_8859_1_SET = { { "nbsp", "160" }, // non-breaking
																			// space
	...
	private static final String[][] HTML40_SET = { { "fnof", "402" }, // latin
																		// small
																		// f
																		// with
																		// hook
	...
	private Map<String, Integer> entityNameToValue = CollectionUtil
			.createHashMap();
	...
	public Entities(Entities entities) {
		for (Map.Entry<String, Integer> entry : entities.entityNameToValue
				.entrySet()) {
