...
public abstract class ConcurrentUtil {
	...
	public static final void shutdownAndAwaitTermination(
		...
		shutdownAndAwaitTermination(executorService, defaultTimeout,
				TimeUnit.SECONDS);
	...
	public static void execute(boolean asyn, final Object object,
			final String methodName, final Object... inputs) {
		if (asyn) {
	...
	public static void asynExecute(final Object object,
			final String methodName, final Object... inputs) {
		if (object == null || StringUtil.isBlank(methodName)) {
			return;
		}
	...
	private static void doExecute(final Object object, final String methodName,
			final Object... inputs) {
	...
	public static void execute(boolean asyn, final Closure closure,
			final Object... inputs) {
		if (asyn) {
	...
	public static void asynExecute(final Closure closure,
			final Object... inputs) {
		if (closure == null) {
			return;
		}
