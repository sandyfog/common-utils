...
public class ConvertBean {
	...
	protected ObjectConverter<?> objectConverter = ObjectConverter
			.getInstance();
	...
	public Boolean toBoolean(Object value, Boolean defaultValue) {
		Boolean result = (Boolean) objectConverter.toConvert(value,
				Boolean.class);
		if (result == null) {
			return defaultValue;
		}
	...
	public Integer toInteger(Object value, Integer defaultValue) {
		Integer result = (Integer) objectConverter.toConvert(value,
				Integer.class);
		if (result == null) {
			return defaultValue;
		}
	...
	public Character toCharacter(Object value, Character defaultValue) {
		Character result = (Character) objectConverter.toConvert(value,
				Character.class);
		if (result == null) {
			return defaultValue;
		}
	...
	public Calendar toCalendar(Object value, Calendar defaultValue) {
		Calendar result = (Calendar) objectConverter.toConvert(value,
				Calendar.class);
		if (result == null) {
			return defaultValue;
		}
	...
	public BigInteger toBigInteger(Object value, BigInteger defaultValue) {
		BigInteger result = (BigInteger) objectConverter.toConvert(value,
				BigInteger.class);
		if (result == null) {
			return defaultValue;
		}
	...
	public BigDecimal toBigDecimal(Object value, BigDecimal defaultValue) {
		BigDecimal result = (BigDecimal) objectConverter.toConvert(value,
				BigDecimal.class);
		if (result == null) {
			return defaultValue;
		}
