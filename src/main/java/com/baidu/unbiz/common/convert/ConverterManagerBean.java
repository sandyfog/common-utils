...
public class ConverterManagerBean {
	...
	protected static ObjectConverter<?> objectConverter = ObjectConverter
			.getInstance();
	...
	public <T> T convertType(Object value, Class<T> destinationType) {
		...
		if (converter != null) {
			try {
				...
				throw new ClassCastException("Unable to convert to type: "
		...
		throw new ClassCastException("Unable to cast to type: "
				+ destinationType.getName());
	}
