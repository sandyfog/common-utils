...
public class ObjectConverter<T> extends CachedLogger {
	...
	protected static Map<Class<?>, TypeConverter<?>> typeConverters = CollectionUtil
			.createHashMap();
	...
	private static void init() throws IOException, ClassNotFoundException,
		...
		// FIXME
		String packName = PackageUtil.getPackage(ObjectConverter.class)
				.getName() + ".*";
	...
	public T toConvert(String value, Class<?> clazz) {
		...
		TypeConverter<T> converter = (TypeConverter<T>) typeConverters
				.get(clazz);
